			      ...
			      struct ethtool_coalesce *ec)
{
	...
	printk("e1000e itr :%u\n", adapter->itr);
	printk("e1000e itr_setting :%u\n", adapter->itr_setting);
	printk("e1000e tx_int_delay :%u\n", adapter->tx_int_delay);
	printk("e1000e tx_abs_int_delay :%u\n", adapter->tx_abs_int_delay);
	printk("e1000e rx_int_delay :%u\n", adapter->rx_int_delay);
	printk("e1000e rx_abs_int_delay :%u\n", adapter->rx_abs_int_delay);
